    ...
    public void opciones(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        switch (opcion) {
            case "insert": {
                ...
                args.add(request.getParameter("creditos"));
                args.add(request.getParameter("hora_semana"));
                args.add(request.getParameter("anno"));
                args.add(request.getParameter("ciclo"));
                args.add(request.getParameter("carrera"));
                proccess = "procedure";
            }
            break;
            case "update": {
