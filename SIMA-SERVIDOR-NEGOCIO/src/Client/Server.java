        ...
        switch (message.getType_process()) {
            case "function": {
                if (!message.getArgs().isEmpty()) {
                    result.setObject(controller.function(message.getOpcion(), (String[])message.getArgs().toArray()));
                } else {
            ...
            break;
            case "procedure": {
                controller.procedure(message.getOpcion(), (String[])message.getArgs().toArray());
