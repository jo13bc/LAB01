...
insert into TB_Carrera(Carr_id_PK, Carr_codi, Carr_nomb, Carr_titu) values (1,'A101', 'Informatica', 'Diplomado');
insert into TB_Carrera(Carr_id_PK, Carr_codi, Carr_nomb, Carr_titu) values (2,'A102', 'Matematica', 'Diplomado');
insert into TB_Carrera(Carr_id_PK, Carr_codi, Carr_nomb, Carr_titu) values (3,'A103', 'Agronomia', 'Bachillerato');
insert into TB_Carrera(Carr_id_PK, Carr_codi, Carr_nomb, Carr_titu) values (4,'A104', 'Topografia', 'Bachillerato');
select * from TB_Carrera;

PROMPT #1 inserts Ciclos
insert into TB_Ciclo(Cicl_id_PK, Cicl_anno, Cicl_nume, Cicl_fech_inic, Cicl_fech_fina) values (1, 2020, 1, to_date('12-02-2020','DD-MM-YYYY'), to_date('12-07-2020','DD-MM-YYYY'));
insert into TB_Ciclo(Cicl_id_PK, Cicl_anno, Cicl_nume, Cicl_fech_inic, Cicl_fech_fina) values (2, 2020, 2, to_date('12-07-2020','DD-MM-YYYY'), to_date('12-11-2020','DD-MM-YYYY'));
insert into TB_Ciclo(Cicl_id_PK, Cicl_anno, Cicl_nume, Cicl_fech_inic, Cicl_fech_fina) values (3, 2020, 3, to_date('12-11-2020','DD-MM-YYYY'), to_date('12-02-2021','DD-MM-YYYY'));
...
insert into TB_Curso(Curs_id_PK, Curs_codi, Curs_nomb, Curs_cred, Curs_hora_sema, Curs_anno, Cicl_id_FK, Carr_id_FK)
	values (1,'B101', 'Programacion I', 4, 8, 1, 1, 1);
insert into TB_Curso(Curs_id_PK, Curs_codi, Curs_nomb, Curs_cred, Curs_hora_sema, Curs_anno, Cicl_id_FK, Carr_id_FK)
	values (2,'B102', 'Programacion II', 4, 8, 1, 2, 1);
insert into TB_Curso(Curs_id_PK, Curs_codi, Curs_nomb, Curs_cred, Curs_hora_sema, Curs_anno, Cicl_id_FK, Carr_id_FK)
	values (3,'B103', 'Programacion III', 4, 8, 2, 1, 1);
